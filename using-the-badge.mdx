---
title: 'Using the Proof of Human badge'
sidebarTitle: 'Using the Proof of Human badge'
---

Proof of Human's verification badge is a small, drop-in widget that shows whether Proof of Human is running. It auto-renders wherever you place `<div class="roundtable-badge">`, listens to your tracker’s events, and gracefully handles SPAs and back-navigation.
...
![Proof of Human badge](/images/badge.png)
...
<script src="https://cdn.poh.org/v1/badge.js"></script>
```
...
The badge uses a dark theme by default. For light backgrounds, add `data-theme="light"`:

```html
<div class="roundtable-badge" data-theme="light"></div>
```
...
- **Pass:** displays a check icon in black. This indicates that Proof of Human is running and gathering user data.
